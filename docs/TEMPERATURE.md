...
| Mars held just under CO2's threshold (5.5 CO2, 0.27 N2, 0.131 O2, 0.058 pollutant per cell), a full day | 0.15 K over 59 samples | Day 292 K, night 216 K, under the 220 K the game needs to keep CO2 a gas. **All 5.5 mol per cell left the air in one tick** at dusk (222.1 K to 217.2 K between two samples), pressure 1.38 to 0.10 kPa, and the latent heat that released is 24 K, which the mod's fade then takes back. It sat in the tank as liquid all night, draining into the ice caps at 150 mol per tick planet-wide, the size-scaled rate. After dawn it came back out of the liquid at **exactly 10 % a tick** and was 5.45 of 5.5 back in the air within 60 ticks. So a mix on the wrong side of a threshold does not linger or oscillate: it cycles whole, every night, and the 0.8 % per night that reaches the ice caps melts back by day |
| Vulcan on the fire-safe recipe, an ash storm forced on at tick 40 | 0.17 K over 51 samples | The storm's own offsets are -275 K by day and +150 K by night. Scaled to the planet they read about -113 and +84 K: **163 K at dusk, 215 K at noon, 356 K at night**, against 273 to 278 K calm. Oxygen 193 and nitrogen 46 per cell stayed in the air; the 19 CO2 and the 1 pollutant snowed into the ice clouds (20 mol per cell), below their 220 and 175 K thresholds, as the model says. Unscaled, -275 K on a 277 K planet is 2 K. The event is identified by the id and the offsets the driver prints after activating, not by the id asked for: forcing a storm by name can silently fall back to a random one (VERIFICATION.md) |
...
Results are in BALANCE.md. What is still open is in ASSUMPTIONS.md (S10 to S12) and ROADMAP.md.
