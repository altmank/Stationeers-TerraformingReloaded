...
| Trace gases | TraceGasGathering | Speed at the trace line (x) | Speed at the trace line: how many times faster than any other gas the outdoor air beside your base draws a gas the planet holds just under the trace line. Default 200, settable 1 to 2000; 1 turns gathering off. Below the line the speed doubles for every factor of ten, up to 10x the line speed. | 200.0 | The world | Yes, with `terraform set TraceGasGathering <value>` |
