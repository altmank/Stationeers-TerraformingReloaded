    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void BindConfig()
        {
            ...
            Bind("Trace gases", "TraceGasGathering", Settings.TraceGasGathering,
                "Speed at the trace line: how many times faster than any other gas the outdoor air beside your base draws a gas the planet holds just under the trace line. Default 200, settable 1 to 2000; 1 turns gathering off. Below the line the speed doubles for every factor of ten, up to 10x the line speed.",
                v => Settings.TraceGasGathering = v, Bounds(Limits.TraceGasGathering), "Speed at the trace line (x)", 61, "%.0f", world: true);
